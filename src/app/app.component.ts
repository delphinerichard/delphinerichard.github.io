...
export class AppComponent {
  ...
  // convertToPDF() {
  //   const data = document.getElementById('all-content');
  //   if (data) {
  ...
  //       pdf.save('cv-delphine-richard.pdf'); // Generated PDF
  //     });
  //   }
  // }
  ...
  convertToPDF() {
    ...
    const textContent = document.getElementById('all-content')
      ?.innerText as string;
    const doc = new jspdf();
    ...
    // const pages = document.getElementById('all-content') as HTMLElement;
    // const doc = new jspdf('p', 'mm', 'a4');
    // = new jspdf({
    //   unit: 'px',
    //   format: [595, 842], // A4 size page of PDF
    // });

    // doc.html(pages, {
    //   callback: (doc: jspdf) => {
    //     doc.deletePage(doc.getNumberOfPages());
    //     doc.save('delphine-richard');
    //   },
    // });
  }
}
